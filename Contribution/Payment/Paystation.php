...
class CRM_Contribute_Payment_Paystation extends CRM_Core_Payment_Paystation { 
    /** 
    ...
    static function &singleton( $mode, &$paymentProcessor ) {
        ...
        if (self::$_singleton[$processorName] === null ) {
            self::$_singleton[$processorName] =& new CRM_Contribute_Payment_Paystation( $mode, $paymentProcessor );
        }
